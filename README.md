...
文档站点已开启 **本地搜索**（基于 VitePress 内置 MiniSearch），部署到 **S3/内网**也可正常使用：

- **入口**：页面右上角会出现“Search / 搜索”按钮，点击即可打开搜索框
- **快捷键**：在页面内按下 `Ctrl + K`（macOS 为 `⌘ + K`）可快速打开搜索
- **语言**：在英文/中文页面会自动显示对应语言的搜索文案
