...
- ### 通道配置
  ...
  - [通道模板管理](/cn/manuals/system-config/channels/template-ops.html)
    - [模板查看与筛选](/cn/manuals/system-config/channels/template-ops.html#模板查看与筛选)
    - [访问通道模板](/cn/manuals/system-config/channels/template-ops.html#访问通道模板)
    - [创建通道模板](/cn/manuals/system-config/channels/template-ops.html#创建通道模板)
    - [应用模板到通道](/cn/manuals/system-config/channels/template-ops.html#应用模板到通道)
    - [编辑模板](/cn/manuals/system-config/channels/template-ops.html#编辑模板)
    - [查看模板详情](/cn/manuals/system-config/channels/template-ops.html#查看模板详情)
    - [删除模板](/cn/manuals/system-config/channels/template-ops.html#删除模板)
