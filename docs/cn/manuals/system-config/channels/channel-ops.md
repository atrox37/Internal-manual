...
通道管理页面用于维护系统中的通道实例，是通道配置的主入口之一。该页面覆盖了从“查询定位”到“维护变更”的完整流程，适合日常运维和首次部署时使用。
通过本页面，您可以：

- **快速筛选定位目标通道**：支持按协议类型、启用状态、连接状态进行组合查询
- **维护通道基础参数**：支持查看详情、编辑参数、新增通道与删除通道
- **调整通道启用状态**：可直接在列表中开关 enable 状态，快速生效
- **作为模板操作入口**：可从通道行触发模板导出、模板点位替换等后续动作
