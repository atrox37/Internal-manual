...
- ### Channels Configuration
  ...
  - [Channel Template Management](/manuals/system-config/channels/template-ops.html)
    - [Template View and Filter](/manuals/system-config/channels/template-ops.html#template-view-and-filter)
    - [Access Channel Templates](/manuals/system-config/channels/template-ops.html#access-channel-templates)
    - [Create Channel Template](/manuals/system-config/channels/template-ops.html#create-channel-template)
    - [Apply Template to Channel](/manuals/system-config/channels/template-ops.html#apply-template-to-channel)
    - [Edit Template](/manuals/system-config/channels/template-ops.html#edit-template)
    - [View Template Details](/manuals/system-config/channels/template-ops.html#view-template-details)
    - [Delete Template](/manuals/system-config/channels/template-ops.html#delete-template)
